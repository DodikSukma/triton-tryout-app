...
export default function BuatTryoutPage() {
  ...
  return (
    <div className="animate-fade-in-up pb-8 max-w-2xl mx-auto">
      <Link href="/guru/dashboard" className="inline-flex items-center gap-2 text-slate-500 hover:text-triton-blue-600 transition-colors mb-6 font-medium">
        <ArrowLeft size={18} />
        Kembali ke Dashboard
      </Link>
      
      <div className="mb-8">
        <h1 className="text-3xl font-extrabold text-slate-900 tracking-tight">Buat Tryout Baru</h1>
        <p className="text-slate-500 mt-2">Isi detail tryout di bawah ini untuk mulai menambahkan soal.</p>
      </div>

      <form onSubmit={handleSubmit} className="bg-white rounded-[2rem] border border-slate-100 p-8 sm:p-10 shadow-glass flex flex-col gap-6">
        <div className="group">
          <label className="flex items-center gap-2 text-sm font-bold text-slate-700 mb-2 transition-colors group-focus-within:text-triton-blue-600">
          ...
          <input
            ...
            className="w-full px-5 py-3.5 rounded-2xl bg-slate-50/50 border border-slate-200 focus:outline-none focus:ring-4 focus:ring-triton-blue-500/20 focus:border-triton-blue-500 text-slate-900 transition-all font-medium placeholder:font-normal placeholder:text-slate-400"
          />
        </div>
        <div className="group">
          <label className="flex items-center gap-2 text-sm font-bold text-slate-700 mb-2 transition-colors group-focus-within:text-triton-blue-600">
        ...
        <div className="group">
          ...
          <input
            ...
            min={10}
            required
            className="w-full px-5 py-3.5 rounded-2xl bg-slate-50/50 border border-slate-200 focus:outline-none focus:ring-4 focus:ring-triton-blue-500/20 focus:border-triton-blue-500 text-slate-900 transition-all font-medium"
          />
        </div>
