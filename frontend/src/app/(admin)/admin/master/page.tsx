...
import { Plus, Trash2, Loader2, X, Layers, BookOpen, GraduationCap, ChevronDown } from 'lucide-react'
    ...
    <div className="p-4 md:p-6 lg:p-10 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
        ...
        <Section
          ...
          onAdd={() => mapel.length === 0 ? toast.error('Tambah mata pelajaran dulu.') : setDialog('sub')}
          count={sub.length}
        >
      ...
      {dialog === 'sub' && (
        <FormDialog
          title="Tambah Sub Mata Pelajaran"
          fields={['nama', 'mapel']}
          mapelOptions={mapel}
          onClose={() => setDialog(null)}
