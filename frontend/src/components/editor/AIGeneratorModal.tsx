    ...
    try {
      for (const q of generated) {
        const body = {
          ...
          opsi: q.tipe === 'pilihan_ganda'
            ? q.opsi.map((o) => ({ huruf: o.huruf, teks: o.teks_html, teks_html: o.teks_html, is_benar: o.is_benar }))
            : undefined,
        }
        await api.post<ApiResponse<Soal>>(`/tryouts/${tryoutId}/soal`, body)
      }
      toast.success(`${generated.length} soal berhasil ditambahkan!`)
      onSaved()
      onClose()
    } catch (err) {
