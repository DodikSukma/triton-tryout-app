export interface AiPresetQuestion {
  ...
  bobot: number
  opsi: { huruf: string; teks_html: string; is_benar: boolean }[]
  panduan_essay: string | null
}

export const AI_PRESETS: Record<string, { set_1: AiPresetQuestion[]; set_5: AiPresetQuestion[] }> = {
  matematika: {
    set_1: [
      {
        tipe: 'pilihan_ganda',
    ...
    set_5: [
      ...
      },
      {
        tipe: 'essay',
        pertanyaan_html:
          'Sebuah peluru ditembakkan vertikal ke atas dengan kecepatan awal <strong>v₀ = 40 m/s</strong>. Jika percepatan gravitasi <strong>g = 10 m/s²</strong>, tentukan:<br/><br/>a) Waktu yang diperlukan peluru untuk mencapai titik tertinggi<br/>b) Ketinggian maksimum yang dicapai peluru<br/>c) Waktu total peluru berada di udara',
        equation_latex: 'v_0 = 40 \\text{ m/s}, \\quad g = 10 \\text{ m/s}^2',
        bobot: 5,
        opsi: [],
        panduan_essay:
          'a) t = v₀/g = 40/10 = 4 detik\nb) h_max = v₀²/(2g) = 1600/20 = 80 meter\nc) t_total = 2t = 8 detik\n\nRubrik: a=2pts, b=2pts, c=1pt',
      },
    ],
  },
  fisika: {
    set_1: [
      {
        tipe: 'pilihan_ganda',
        pertanyaan_html:
          'Sebuah benda bermassa <strong>5 kg</strong> dikenai gaya sebesar <strong>20 N</strong>. Berapakah percepatan yang dialami benda tersebut? (Gunakan Hukum Newton II: <em>F = ma</em>)',
    ...
    set_5: [
      {
        tipe: 'pilihan_ganda',
        pertanyaan_html:
          'Sebuah benda bergerak dengan kecepatan awal <strong>10 m/s</strong> dan mengalami perlambatan <strong>2 m/s²</strong>. Berapa jarak yang ditempuh benda hingga berhenti?',
      ...
      },
      {
        tipe: 'pilihan_ganda',
        pertanyaan_html:
          'Sebuah pegas dengan konstanta pegas <strong>k = 200 N/m</strong> ditarik sejauh <strong>x = 0,05 m</strong>. Berapakah energi potensial pegas tersebut?',
      ...
      },
      {
        tipe: 'pilihan_ganda',
        pertanyaan_html:
          'Dua muatan listrik masing-masing <strong>q₁ = 2 μC</strong> dan <strong>q₂ = 4 μC</strong> terpisah sejauh <strong>r = 2 cm</strong>. Besar gaya Coulomb antara kedua muatan adalah... (k = 9×10⁹ Nm²/C²)',
      ...
      },
      {
        tipe: 'pilihan_ganda',
        pertanyaan_html:
          'Sebuah transformator memiliki kumparan primer <strong>N₁ = 1000 lilitan</strong> dan kumparan sekunder <strong>N₂ = 200 lilitan</strong>. Jika tegangan primer <strong>V₁ = 220 V</strong>, berapakah tegangan sekunder?',
      ...
      },
      {
        tipe: 'essay',
        pertanyaan_html:
          'Jelaskan perbedaan antara <strong>gelombang transversal</strong> dan <strong>gelombang longitudinal</strong>! Berikan masing-masing <strong>2 contoh</strong> dalam kehidupan sehari-hari dan jelaskan karakteristik utama masing-masing jenis gelombang.',
        equation_latex: null,
        bobot: 5,
        opsi: [],
        panduan_essay:
          'Gelombang Transversal: arah getar tegak lurus arah rambat. Contoh: gelombang cahaya, gelombang tali. Karakteristik: memiliki puncak dan lembah.\n\nGelombang Longitudinal: arah getar sejajar arah rambat. Contoh: gelombang bunyi, gelombang pegas. Karakteristik: memiliki rapatan dan regangan.\n\nRubrik: definisi=2pts, contoh=2pts, karakteristik=1pt',
      },
    ],
  },
  biologi: {
    set_1: [
      {
        tipe: 'pilihan_ganda',
        pertanyaan_html:
          'Organel sel yang berperan sebagai <strong>pusat respirasi seluler</strong> dan penghasil energi dalam bentuk ATP adalah...',
        equation_latex: null,
        bobot: 2,
        opsi: [
    ...
    set_5: [
      ...
      },
      {
        tipe: 'pilihan_ganda',
        pertanyaan_html:
          'Dalam pewarisan sifat Mendel, persilangan antara tanaman berbunga merah (<strong>MM</strong>) dengan tanaman berbunga putih (<strong>mm</strong>) menghasilkan F1. Jika F1 disilangkan sesamanya, persentase tanaman berbunga <strong>putih</strong> pada F2 adalah...',
      ...
      },
      {
        tipe: 'pilihan_ganda',
        pertanyaan_html:
          'Enzim yang berperan dalam proses <strong>replikasi DNA</strong> dengan cara memutus ikatan hidrogen antar basa nitrogen sehingga double helix terbuka adalah...',
        equation_latex: null,
        bobot: 2,
        opsi: [
      ...
      },
      {
        tipe: 'essay',
        pertanyaan_html:
          'Jelaskan mekanisme <strong>sistem imun tubuh manusia</strong> dalam melawan infeksi bakteri! Uraikan peran dari:<br/><br/>a) Sel darah putih (leukosit) — sebutkan jenisnya<br/>b) Antibodi — bagaimana cara kerjanya<br/>c) Perbedaan imunitas <em>aktif</em> dan imunitas <em>pasif</em>',
        equation_latex: null,
        bobot: 5,
        opsi: [],
        panduan_essay:
          'a) Leukosit: neutrofil (fagositosis), limfosit B (antibodi), limfosit T (serang sel terinfeksi), monosit (fagosit besar), eosinofil.\nb) Antibodi: protein Y yang diproduksi limfosit B, berikatan dengan antigen spesifik, menetralkan atau menandai untuk dihancurkan.\nc) Aktif: tubuh memproduksi antibodi sendiri (infeksi alami / vaksin). Pasif: menerima antibodi dari luar (ASI, injeksi imunoglobulin).\n\nRubrik: a=2pts, b=2pts, c=1pt',
      },
    ],
  },
}
